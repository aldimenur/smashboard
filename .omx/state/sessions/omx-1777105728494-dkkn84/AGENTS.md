...
<!-- OMX:RUNTIME:START -->
<session_context>
**Session:** omx-1777105728494-dkkn84 | 2026-04-25T08:28:49.247Z

**Codebase Map:**
  src/: App, main, vite-env.d
  src/components/: ExportDialog, GlobalShortcutToggle, KeyboardShortcuts, MissingFilesDialog, ProjectMenu, RecordingTransport, ShortcutInput, SlotCard, SlotGrid, StatusBar
  src/hooks/: useSlots
  src/types/: index
  src/utils/: shortcut
  (root): vite.config
